...
import './developer_sosalmidia.css'
import { FaFacebook, FaGithubAlt, FaPhone } from 'react-icons/fa';
import { PiFaceMaskFill } from 'react-icons/pi';
import { MdOutlineMail } from 'react-icons/md';

const DeveloperSosalmedia = () => {
    return (
        <div>

            <div className="bg-slate-300  border-y-2 border-gray-950">
                <h1 className="text-center text-3xl font-bold py-10 md:text-5xl">
                    Developer Social Media
                </h1>
            </div>
            <div className=' w-[90%] mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5 py-10 md:py-20'>

                {/* first catd */}
                <div class="developer_sosalmidia">
                    <img
                        src="https://uiverse.io/build/_assets/astronaut-WTFWARES.png"
                        alt=""
                        class="image"
                    />
                    <div class="heading">Md Sujon Mia</div>
...
export default DeveloperSosalmedia;
